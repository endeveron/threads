  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        outline: 'bg-transparent !rounded-none !p-0', // 'border border-zinc-200 bg-white hover:bg-zinc-100 hover:text-zinc-900 dark:border-zinc-800 dark:bg-main dark:hover:bg-zinc-800 dark:hover:text-zinc-50',
