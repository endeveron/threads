...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors disabled:pointer-events-none',
  {
    variants: {
      variant: {
        default: 'rounded-lg text-main bg-button',
        ...
        outline: 'bg-transparent !p-0', // 'border border-zinc-200 bg-white hover:bg-zinc-100 hover:text-zinc-900 dark:border-zinc-800 dark:bg-main dark:hover:bg-zinc-800 dark:hover:text-zinc-50',
